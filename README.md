...
If Superpowers has helped you do stuff that makes money and you are so inclined, I'd greatly appreciate it if you'd consider [sponsoring my opensource work](https://github.com/sponsors/arsolitt).
...
```bash
/plugin marketplace add arsolitt/superpowers-marketplace
```
...
```
Fetch and follow instructions from https://raw.githubusercontent.com/arsolitt/superpowers/refs/heads/main/.codex/INSTALL.md
```
...
```
Fetch and follow instructions from https://raw.githubusercontent.com/arsolitt/superpowers/refs/heads/main/.opencode/INSTALL.md
```
...
```bash
gemini extensions install https://github.com/arsolitt/superpowers
```
...
- **Issues**: https://github.com/arsolitt/superpowers/issues
- **Marketplace**: https://github.com/arsolitt/superpowers-marketplace
