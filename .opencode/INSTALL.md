...
```json
{
  "plugin": ["superpowers@git+https://github.com/arsolitt/superpowers.git"]
}
```
...
- Report issues: https://github.com/arsolitt/superpowers/issues
- Full documentation: https://github.com/arsolitt/superpowers/blob/main/docs/README.opencode.md
